...
_LINE_SCHEMA = {
    ...
    'properties': {
        ...
        'suggested_account_category': {
            'type': ['string', 'null'],
            'enum': [
                None, '', 'consulting', 'it_services', 'office_supplies',
                'shipping', 'freight', 'telecom', 'insurance', 'rent',
                'maintenance', 'advertising', 'travel', 'training',
                'cleaning', 'subscriptions', 'software', 'legal',
                'accounting', 'bank_fees', 'utilities', 'raw_materials',
                'merchandise', 'subcontracting',
            ],
        },
        'confidence': {'type': 'number'},
    },
